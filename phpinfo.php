<?php
	...
	$phpinfo = str_replace('<a href="http://www.php.net/">','<a href="http://www.php.net/" target="_blank">',$phpinfo);
	$phpinfo = str_replace('<a href="http://www.zend.com/">','<a href="http://www.zend.com/" target="_blank">',$phpinfo);
